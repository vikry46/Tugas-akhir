    ...
    <div class="form-group">
        <div class="form-group">
            ...
            <div class="container">
                ...
                <input type="text" id="keterangan" name="keterangan" value="{{ old('keterangan',$sosial->keterangan) }}" class="form-control @error('keterangan') is-invalid @enderror" placeholder="ubah">
                @error('keterangan')
                    <label style="color: gold">{{ $message }}</label>
                @enderror
            </div>
